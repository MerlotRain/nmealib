...
static int
_nmea_parse_time(const char *buff, int buff_sz, nmeaTIME *res)
{
	int success = 0;
 ...
 */
int
nmea_pack_type(const char *buff, int buff_sz)
{
 ...
 */
int
nmea_parse_GPGGA(const char *buff, int buff_sz, nmeaGPGGA *pack)
{
	...
	if (0 != _nmea_parse_time(
		     &time_buff[0], (int)strlen(&time_buff[0]), &(pack->utc)))
	{
 ...
 */
int
nmea_parse_GPGSA(const char *buff, int buff_sz, nmeaGPGSA *pack)
{
	assert(buff && pack);
 ...
 */
int
nmea_parse_GPGSV(const char *buff, int buff_sz, nmeaGPGSV *pack)
{
	int nsen, nsat;
	...
	nsat = (nsat + NMEA_SATINPACK > pack->sat_count)
		   ? pack->sat_count - nsat
		   : NMEA_SATINPACK;
 ...
 */
int
nmea_parse_GPRMC(const char *buff, int buff_sz, nmeaGPRMC *pack)
{
	int nsen;
	char time_buff[NMEA_TIMEPARSE_BUF];
 ...
 */
int
nmea_parse_GPVTG(const char *buff, int buff_sz, nmeaGPVTG *pack)
{
	assert(buff && pack);
 ...
 */
void
nmea_GPGGA2info(nmeaGPGGA *pack, nmeaINFO *info)
{
	assert(pack && info);
 ...
 */
void
nmea_GPGSA2info(nmeaGPGSA *pack, nmeaINFO *info)
{
	int i, j, nuse = 0;
 ...
 */
void
nmea_GPGSV2info(nmeaGPGSV *pack, nmeaINFO *info)
{
	int isat, isi, nsat;
 ...
 */
void
nmea_GPRMC2info(nmeaGPRMC *pack, nmeaINFO *info)
{
	assert(pack && info);
 ...
 */
void
nmea_GPVTG2info(nmeaGPVTG *pack, nmeaINFO *info)
{
	assert(pack && info);
