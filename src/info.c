 ...
 */
bool
nmea_INFO_has_field(int smask, nmeaINFO_FIELD fieldName)
{
	switch (fieldName)
	{
	case SMASK:
 ...
 */
void
nmea_INFO_sanitise(nmeaINFO *nmeaInfo)
{
	double lat = 0;
	double lon = 0;
	double speed = 0;
 ...
 */
void
nmea_INFO_unit_conversion(nmeaINFO *nmeaInfo)
{
	if (!nmeaInfo)
	{
		return;
